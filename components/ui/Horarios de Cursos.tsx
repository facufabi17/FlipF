            ...
            <div className="flex items-center gap-3 relative group">
                <div className="relative flex-1">
                    <select
                        ...
                        className="appearance-none w-full bg-black/20 border border-white/10 rounded-lg px-4 py-2 pr-10 text-sm focus:outline-none focus:border-tech transition-colors cursor-pointer text-white font-medium"
                    >
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none text-gray-400 group-hover:text-tech transition-colors">
                ...
                {selected && (
                    <div className="text-xs text-tech flex items-center gap-1 whitespace-nowrap animate-fade-in">
    ...
    return (
        <div className="mb-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h3 className="text-sm font-bold text-gray-300 mb-3 uppercase tracking-wider flex items-center gap-2">
                <span className="material-symbols-outlined text-tech text-base">calendar_month</span>
                Elige tu horario <span className="text-tech">*</span>
            </h3>
                    ...
                    return (
                        <button
                            ...
                            className={`
                                ...
                                ${isSelected
                                    ? 'bg-tech/10 border-tech text-tech shadow-[0_0_15px_rgba(0,245,241,0.2)]'
            ...
            {!selectedScheduleId && (
                <p className="text-xs text-tech/70 mt-2 flex items-center gap-1">
