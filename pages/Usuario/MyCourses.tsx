                ...
                {myCourses.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {myCourses.map(course => {
                            ...
                            // Calcular progreso real basado en módulos completados
                            const completedModulesCount = user?.progress?.[course.id]?.length || 0;
                            ...
                            // Asegurar que no pase de 100% visualmente
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between text-xs font-bold uppercase tracking-wider">
                                                ...
                                                <span className="text-tech">{displayPercentage}%</span>
                                            </div>
                                            <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                                                <div className="h-full bg-tech transition-all duration-500 ease-out" style={{ width: `${displayPercentage}%` }}></div>
                                            </div>
                                        </div>
