        ...
        <div className="w-full px-6 pt-16 pb-8 md:pt-24 md:pb-12 max-w-5xl mx-auto text-center relative animate-fade-in">
            ...
            <div className="w-full px-6 py-20 max-w-4xl mx-auto text-left">
                ...
                <div className="relative pl-8 md:pl-0">
                    ...
                    <div className="absolute left-[34px] top-0 bottom-0 w-px bg-gradient-to-b from-primary/80 via-primary/40 md:hidden"></div>
                    
                    {/* Level 1 */}
                    <div className="relative flex flex-col md:flex-row items-center gap-8 mb-16 group">
                        <div className="md:w-1/2 md:text-right order-2 md:order-1 flex-1">
                    ...
                    <div className="relative flex flex-col md:flex-row items-center gap-8 mb-16 group">
                         <div className="md:w-1/2 order-3 flex-1 md:block hidden"></div>
                         <div className="absolute left-1/2 -translate-x-1/2 z-10 flex items-center justify-center shrink-0">
                         ...
                         <div className="w-full md:w-1/2 ml-auto md:text-left order-2 md:order-3 flex-1 pl-12 md:pl-16">
